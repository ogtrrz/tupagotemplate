package com.tupago.shared.collection.domain;
...
@UnitTest
class TuPagoTemplateCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class TuPagoTemplateCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = TuPagoTemplateCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = TuPagoTemplateCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class TuPagoTemplateCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = TuPagoTemplateCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = TuPagoTemplateCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class TuPagoTemplateCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = TuPagoTemplateCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = TuPagoTemplateCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class TuPagoTemplateMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = TuPagoTemplateCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = TuPagoTemplateCollections.immutable(input);
