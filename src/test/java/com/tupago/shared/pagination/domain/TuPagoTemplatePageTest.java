...
@UnitTest
class TuPagoTemplatePageTest {

  @Test
  void shouldGetEmptySinglePageWithoutContent() {
    TuPagoTemplatePage<String> page = TuPagoTemplatePage.singlePage(null);
  ...
  void shouldGetEmptySinglePageFromBuilderWithoutContent() {
    TuPagoTemplatePage<?> page = TuPagoTemplatePage.builder(null).build();

    assertEmptyPage(page);
  }

  private void assertEmptyPage(TuPagoTemplatePage<?> page) {
  ...
  void shouldGetSinglePage() {
    TuPagoTemplatePage<String> page = TuPagoTemplatePage.singlePage(List.of("test", "dummy"));
  ...
  void shouldGetSinglePageFromBuilderWithContentOnly() {
    TuPagoTemplatePage<String> page = TuPagoTemplatePage.builder(List.of("test", "dummy")).build();

    assertSinglePage(page);
  }

  private void assertSinglePage(TuPagoTemplatePage<String> page) {
  ...
  void shouldGetFullPage() {
    TuPagoTemplatePage<String> page = pageBuilder().build();
  ...
  @Test
  void shouldMapPage() {
    TuPagoTemplatePage<String> page = pageBuilder().build().map(entry -> "hey");
  ...
  void shouldBeLastWithOnePage() {
    assertThat(TuPagoTemplatePage.singlePage(List.of("d")).isNotLast()).isFalse();
  }

  @Test
  void shouldBeLastPageWithoutContent() {
    TuPagoTemplatePage<Object> page = TuPagoTemplatePage.builder(List.of()).currentPage(0).pageSize(1).totalElementsCount(0).build();
  ...
  void shouldGetPageFromElements() {
    TuPagoTemplatePage<String> page = TuPagoTemplatePage.of(List.of("hello", "java", "world"), new TuPagoTemplatePageable(1, 1));
  ...
  void shouldGetEmptyPageFromOutOfBoundElements() {
    TuPagoTemplatePage<String> page = TuPagoTemplatePage.of(List.of("hello", "java", "world"), new TuPagoTemplatePageable(4, 1));
  ...
  void shouldGetPageWithLessThanExpectedElements() {
    TuPagoTemplatePage<String> page = TuPagoTemplatePage.of(List.of("hello", "java", "world"), new TuPagoTemplatePageable(0, 4));
