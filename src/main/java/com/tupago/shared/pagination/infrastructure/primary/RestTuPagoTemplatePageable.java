...
@Schema(name = "TuPagoTemplatePageable", description = "Pagination information")
public class RestTuPagoTemplatePageable {

  private int page;
  private int pageSize = 10;

  @ExcludeFromGeneratedCodeCoverage
  public RestTuPagoTemplatePageable() {}

  public RestTuPagoTemplatePageable(int page, int pageSize) {
    this.page = page;
  ...
  public TuPagoTemplatePageable toPageable() {
    return new TuPagoTemplatePageable(page, pageSize);
  }
}
